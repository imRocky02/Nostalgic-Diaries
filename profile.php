...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-lg-between" style="height: 50px;">
            ...
            <a href="login/user.php" class="get-started-btn scrollto">Get Started &rarr;</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-info">
                            ...
                            <div class="social-links mt-3">
                                <a href="https://mobile.twitter.com/Nostalgia_Diary" class="twitter"><i class="bx bxl-twitter"></i></a>
                                <!--<a href="#" class="facebook"><i class="bx bxl-facebook"></i></a>--->
                                <a href="https://www.instagram.com/nostalgiadiary_/" class="instagram"><i class="bx bxl-instagram"></i></a>
                                <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCHrgDMmzWZwlnkFVLDKrlsMHTtfZFkBnTbRsVxnVGxdRfpBhrbwGPSWxTnhMNWnWcJTJZGV " class="google-plus"><i class="bx bxl-google"></i></a>
